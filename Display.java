...
public class Display{					
	...
	public static ImageIcon flagIcon = new ImageIcon("flowerFlag.png");  
	public static ImageIcon bombIcon = new ImageIcon("boom.png");
	public static ImageIcon unclickedIcon = new ImageIcon("unclicked.png");
	public static ImageIcon nullIcon = new ImageIcon("empty.png");
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
					...
					if(cols <= 5 || cols  >= 25 || rows <=5 || rows >= 15 || mines <= 5 || mines >= upperBound){
						JOptionPane.showMessageDialog(frame, "Cannot create a new game.Please try again!");
					}
					else{
